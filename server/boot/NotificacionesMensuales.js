      ...
      if (p == servuce.length) {
        axios.post(
          "https://onesignal.com/api/v1/notifications",
          {
            ...
            contents: {
              en:
                "Listo!Ingresa a la app para saber cual fue el consumo y generacion de energia que tuviste el dia de ayer "
            },
    ...
    if (p != y - 1) {
      designatedMeter
        ...
        .then(Info => {
          ...
          Infos.devices.forEach(Devices => {
            Meter.getConsumptionCostsByFilter(
              Infos.meter_id, // id del meter
          ...
          Infos.services.forEach(service => {
            Meter.getConsumptionCostsByFilter(
              Infos.meter_id, // id del meter
