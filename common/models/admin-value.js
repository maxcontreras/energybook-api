            ...
            AdminValue.findOne(
                ...
                if (value) {
                    if(value["GDMTH"] === undefined || value["GDMTH"] === null || Object.keys(value["GDMTH"]).length === 0) {
                        ...
                        value.GDMTH.distributionPrice = Constants.CFE.values.distribution_price;
                    }
        ...
        if ((tariffType === "GDMTH" || tariffType === "GDMTO") &&
            ...
            AdminValue.findOne(
                ...
                if (value) {
                    ...
                    value[tariffType].distributionPrice = parseFloat(payload.distribution);    
                    ...
                    value.save((err, newVal) => {
                        ...
                        if(newVal["GDMTH"] === undefined || newVal["GDMTH"] === null || Object.keys(newVal["GDMTH"]).length === 0) {
                            ...
                            newVal.GDMTH.distributionPrice = Constants.CFE.values.distribution_price;
                        }
                    ...
                    AdminValue.create(obj).then(() => {
                        if(obj["GDMTH"] === undefined || obj["GDMTH"] === null || Object.keys(obj["GDMTH"]).length === 0) {
                            obj["GDMTH"] = {};
                            obj.GDMTH.basePrice = Constants.CFE.values.consumption_price.base;
                            obj.GDMTH.middlePrice = Constants.CFE.values.consumption_price.middle;
                            obj.GDMTH.peakPrice = Constants.CFE.values.consumption_price.peak;
                            obj.GDMTH.capacityPrice = Constants.CFE.values.capacity_price;
                            obj.GDMTH.distributionPrice = Constants.CFE.values.distribution_price;
                        }
                        if (obj["GDMTO"] === undefined || obj["GDMTO"] === null || Object.keys(obj["GDMTO"]).length === 0) {
                            obj["GDMTO"] = {};
                            obj.GDMTO.ordinaryPrice = Constants.CFE.values.GDMTO.prices.ordinary;
                            obj.GDMTO.capacityPrice = Constants.CFE.values.GDMTO.prices.capacity;
                            obj.GDMTO.distributionPrice = Constants.CFE.values.GDMTO.prices.distribution;
                        }
                        cb(null, obj);
                    }).catch(err => {
                       console.log(err); 
